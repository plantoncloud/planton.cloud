...
export const Pricing: FC = () => {
  return (
    <Box className="mt-2 md:mt-20 pt-16 md:pt-36 pb-48 md:pb-96 bg-slate-950 relative z-10">
      <Stack className="mx-auto px-5 items-center">
        ...
        <Box className="w-[85%] aspect-square origin-top-left opacity-10 mix-blend-screen bg-gradient-to-b from-transparent from-50% to-indigo-950 to-90% rounded-full blur-sm absolute mx-auto -top-[700px]" />
        <Box className="w-[95%] aspect-square origin-top-left opacity-20 mix-blend-screen bg-gradient-to-b from-transparent from-50% to-indigo-800 to-90% rounded-full blur-sm absolute mx-auto -top-[650px]" />
        <Box className="w-[105%] aspect-square origin-top-left opacity-40 mix-blend-screen bg-gradient-to-b from-transparent from-50% to-purple-600 to-90% rounded-full blur-sm absolute mx-auto -top-[600px]" />
